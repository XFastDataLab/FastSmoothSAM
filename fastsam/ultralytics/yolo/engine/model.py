...
TASK_MAP = {
    'classify': [
        ClassificationModel,v8.classify.ClassificationTrainer, v8.classify.ClassificationValidator,  v8.classify.ClassificationPredictor],
    'detect': [
        DetectionModel, v8.detect.DetectionTrainer, v8.detect.DetectionValidator, v8.detect.DetectionPredictor],
    'segment': [
        SegmentationModel, v8.segment.SegmentationTrainer, v8.segment.SegmentationValidator, v8.segment.SegmentationPredictor],
...
class YOLO:
    ...
    def predict(self, source=None, stream=False, **kwargs):
        ...
        is_cli = (sys.argv[0].endswith('yolo') or sys.argv[0].endswith('....')) and any(
