...
class BaseTrainer:
    ...
    def _do_train(self, world_size=1):
        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            #         #     fo = open("a100.txt", "w")
            #         #     fo.write('-'*20 + '\n')
            #         #     fo.write('epoch init start : ' + str(t1) + '\n')
            #         #     fo.write('epoch init end : ' + str(t2) + '\n')
            #         #     fo.write('epoch init length : ' + str(t2 - t1) + '\n')
            #         #     fo.close()
            #         for i, batch in pbar:
            #             t3 = time.time()
            ...
            #             #     fo = open("a100.txt", "a")
            #             #     fo.write('-'*20 + '\n')
            #             #     fo.write(str(i) + '_batch init start : ' + str(t3) + '\n')
            #             #     fo.write(str(i) + '_batch init end : ' + str(t4) + '\n')
            #             #     fo.write(str(i) + '_batch init time : ' + str(t4 - t3) + '\n')                    

                            
            #             #     fo.write('-'*20 + '\n')
            #             #     fo.write(str(i) + '_batch forward start : ' + str(t4) + '\n')
            #             #     fo.write(str(i) + '_batch forward end : ' + str(t5) + '\n')
            #             #     fo.write(str(i) + '_batch forward time : ' + str(t5 - t4) + '\n')     
                            
            #             #     fo.write('-'*20 + '\n')
            #             #     fo.write(str(i) + '_batch backward start : ' + str(t5) + '\n')
            #             #     fo.write(str(i) + '_batch backward end : ' + str(t6) + '\n')
            #             #     fo.write(str(i) + '_batch backward time : ' + str(t6 - t5) + '\n')                          
            #             #     fo.write('-'*20 + '\n')
            #             #     fo.write(str(i) + '_batch optimize start : ' + str(t6) + '\n')
            #             #     fo.write(str(i) + '_batch optimize end : ' + str(t7) + '\n')
            #             #     fo.write(str(i) + '_batch optimize time : ' + str(t7 - t6) + '\n')
            #             #     fo.close()
            #     import pickle
            #     file = open('profil.pickle', 'wb')
    ...
    def check_resume(self):
        ...
        # resume = '/raid/platform/dwc/codes/yolo_sa/sa_test/train3/weights/last.pt'
        if resume:
            try:
    ...
    def resume_training(self, ckpt):
        ...
        # ckpt = torch.load('/raid/platform/dwc/codes/yolo_sa/sa_test/train3/weights/last.pt')
        if ckpt is None:
            return
        best_fitness = 0.0
